...
struct Accel: Phases {
    ...
    <p style="text-align:center"><img src="vpll_7.xml" width="30%%"></p>
    ...
    <p style="text-align:center"><img src="vpll_21.xml" width="30%%"></p>
    ...
    static let st21_title = "Немного терминологии"
    static let st21_description = """
    <p>Если вы дошли до данного видео, то вам полезно будет познакомиться с некоторыми международными терминами спидкубинга. Пригодится, если будете смотреть видео на английском, в том числе и приведенные в данной программе.<br/><br/>
    ...
    английском варианте это так называется, <a href="rg2://ytplay?time=0:06&link=4nSnsav3bIU">смотрите в видео</a> :)))<br/><br/>
    ...
    """
    static let st21_url = "4nSnsav3bIU"
