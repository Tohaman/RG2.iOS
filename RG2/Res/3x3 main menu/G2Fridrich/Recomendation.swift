...
struct Recomend: Phases {
    ...
    static let st1_title = "С чего начать?"
    ...
    <p>Начать стоит с основной \"фишки\" программы - возможности не только прочитать о какой-то головоломке, но и посмотреть нужный момент в видео, если вам что-то непонятно из текста. Например, вы видите в тексте слово <a href="rg2://ytplay?time=0:41&link=QJ8-8l9dQ_U">\"Алгоритм\"</a>, которое выделено цветом. Значит, можно по нему щелкнуть и посмотреть в видео, именно тот момент, как выполнять данный алгоритм.</p>
        ...
        Вот еще примеры равномерной и рваной сборок <a href="rg2://ytplay?time=0:52&link=4nSnsav3bIU">от Дилана Ванга.</a>
    ...
    static let st3_title = "Немного терминологии"
    ...
    """
    static let st3_url = "4nSnsav3bIU"
    
    
    static let st4_title = "Методики из программы vs \"другие\" методики."
    ...
    <p>Например, есть методика А.Кима, но на мой взгляд она не очень подходит для такого вот дистанционного и одностороннего обучения, через программу или ютуб.</p>

    <p>Поэтому, приведу лишь краткое описание последовательности сборки кубика, а более подробно обо всех этапах этой методики вы можете посмотреть в <a href="rg2://ytplay?time=0:00&link=RukIJdEiOoI">видео после текста.</a></p>

    <p>Но сначала хочу сказать большое спасибо Артуру Давлетову и Юсуфу Раминову за присланные ссылки на обучающее видео, а также за помощь в описании методики.</p>

    <p>1. <a href="rg2://ytplay?time=1:35&link=RukIJdEiOoI">Сборка белого креста.</a>
    Крест собирается через желтую сторону, т.е. собираем белый крест на желтой
    строне, а потом легко переставляем на места белые ребра совмещяя их с своими центрами.</p>
    
    <p>2. После креста собираем не сторону, а сначала
    ...
    <p>3. Теперь загоняем на свои места
    ...
    <p>4. Собираем <a href="rg2://ytplay?time=17:18&link=RukIJdEiOoI">верхний крест.</a>
    ...
    <p>5. <a href="rg2://ytplay?time=20:03&link=RukIJdEiOoI">Переворчиваем углы,</a>
    ...
    <p>6. Сначала <a href="rg2://ytplay?time=23:16&link=RukIJdEiOoI">ставим на место углы</a>
    ...
    <p>7. <a href="rg2://ytplay?time=24:31&link=RukIJdEiOoI">Ставим на место ребра</a>
