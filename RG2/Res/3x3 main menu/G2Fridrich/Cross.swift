...
struct Cross: Phases {
    ...
    static let st1_title = "Крест за 8 ходов"
    static let st1_descr = """
        ...
        в подвал или ребра на втором этаже, но на противоположной стороне. Не бойтесь сдвинуть
    ...
    """
    static let st1_url = "O83G5WyDRcs"

    static let st2_title = "Примеры сборок креста"
    static let st2_descr = """
        ...
        <p style="text-align:center"><img src="cross_2_1.xml" width="20%%"></p>
        ...
        кубик должен выглядеть так:</p>
        <p style="text-align:center"><img src="cross_2_2.xml" width="20%%"></p>
        ...
        кубик должен выглядеть так:</p>
        <p style="text-align:center"><img src="cross_2_3.xml" width="20%%"></p>
        ...
        кубик должен выглядеть так:</p>
        <p style="text-align:center"><img src="cross_2_4.xml" width="20%%"></p>
    ...
    """
    static let st2_url = "O83G5WyDRcs"

    static let st3_title = "Примеры сборок креста"
    static let st3_descr = """
        ...
        1. Скрамбл из стандартного положения белый верх, зеленый фронт:<br/>
         ...
         выглядеть так:<br/>
         <p style="text-align:center"><img src="cross_3_1.xml" width="20%%"></p>
        ...
        выглядеть так:<br/>
        <p style="text-align:center"><img src="cross_3_2.xml" width="20%%"></p>
        и вот
        ...
        Наченем с установки белооранжевого и белозеленого ребра в 3 хода, и т.к. у нас белокрасное
         ...
         <p style="text-align:center"><img src="cross_3_3.xml" width="20%%"></p>
         и вот как в данном случае можно
         ...
         <p style="text-align:center"><img src="cross_3_4.xml" width="20%%"></p>
    ...
    """
    static let st3_url = "IWXpkfwimo0"
}
