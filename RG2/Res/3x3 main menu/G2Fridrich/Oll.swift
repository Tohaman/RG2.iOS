...
struct Oll: Phases {
    ...
    <p>2. Очень простой для запоминания алгоритм. Делаем \"жирную\" палку и получаем \"Т с блоком\", поворачиваем ее как надо и решаем в два пиф-пафа.<br/>
    ...
    <p>2. Еще один простой для запоминания вариант, хотя и не очень быстрый. Две жирные трешки в начале и в конце, а между ними два пиф-пафа.</p>
    ...
    static let st25_title = "25"
    static let st25_description = """
    """
    static let st25_url = ""
    
    static let st26_title = "26"
    static let st26_description = """
    """
    static let st26_url = ""
    
    static let st27_title = "27"
    static let st27_description = """
    """
    static let st27_url = ""
    
    static let st28_title = "28"
    static let st28_description = """
    """
    static let st28_url = ""
    
    static let st29_title = "29"
    static let st29_description = """
    """
    static let st29_url = ""
    
    static let st30_title = "20"
