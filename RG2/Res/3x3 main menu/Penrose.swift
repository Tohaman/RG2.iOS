...
struct Penrose: Phases {
    ...
    <p>Если <a href="rg2://ytplay?time=4:28&link=Oh7HESee4wY">кратко, то сборка</a> этой головоломки выглядит следующим образом:<br/>
    ...
    """
    static let st2_url = "Oh7HESee4wY"
    
    static let st3_title = "2. Установка уголков первого слоя"
    static let st3_description = """
    <p>Полноценный правильный крест у нас есть, значит, как и в кубике 3х3, будем ставить <a href="rg2://ytplay?time=8:18&link=Oh7HESee4wY">на свои места углы.</a> Тут все аналогично кубику, находим нужный уголок на верхней грани, ставим его над его местом и делаем пиф-пафы до тех пор, пока угол не встанет как надо. Трудности могут возникнуть разве что с трехцветным уголком, т.к. в головоломке два очень похожих, но все-таки разных трехцветных уголка и один не сможет встать на место другого правильно. Подробнее об этом моменте <a href="rg2://ytplay?time=9:11&link=Oh7HESee4wY">в видео.</a></p>

    <p style="text-align:center"><img src="penrose_3_1.xml" width="30%%"></p>

    <p><a href="rg2://ytplay?time=9:03&link=Oh7HESee4wY">Алгоритм:</a> <b>R U R’ U’</b></p>
    ...
    <p>1.1. Можно сделать перехват так, чтобы и ребро, и его место оказались <a href="rg2://ytplay?time=12:54&link=Oh7HESee4wY">на левой грани</a></p>

    <p style="text-align:center"><img src="penrose_4_2.xml" width="20%%"></p>

    <p><a href="rg2://ytplay?time=13:02&link=Oh7HESee4wY">и сделать</a> сначала жирный простой пиф-паф, а потом жирный английский пиф-паф, т.е. <b>(Rw U Rw’ U’)(Rw’ F Rw F’)</b></p>
    ...
    <p><a href="rg2://ytplay?time=13:51&link=Oh7HESee4wY">Алгоритм:</a> <b>(R U R U R)(U’ R’ U’ R’ U’)</b></p>
    ...
    <p><a href="rg2://ytplay?time=17:06&link=Oh7HESee4wY">Алгоритм:</a> <b>F (R U R’ U’) F’</b></p>

    <p>2. <a href="rg2://ytplay?time=17:17&link=Oh7HESee4wY">Бумеранг,</a> т.е. ситуация, когда правильно ориентированные ребра стоят рядом.</p>
    ...
    <p><a href="rg2://ytplay?time=17:33&link=Oh7HESee4wY">Алгоритм:</a> <b>F (R U R’ U’)(R U R’ U’) F’</b></p>

    <p>3. <a href="rg2://ytplay?time=17:43&link=Oh7HESee4wY">Пуля,</a> т.е. ситуация, когда нет ни одного правильно ориентированного ребра.</p>
    ...
    <p>Первым делом, надо повернуть крышу так, чтобы два каких-то угла <a href="rg2://ytplay?time=23:50&link=Oh7HESee4wY">оказались на своем месте.</a> И тут, как и в кубике может быть три ситуации:</p>

    <p>1. Два других уголка тоже оказались на своих местах, т.е. <a href="rg2://ytplay?time=24:05&link=Oh7HESee4wY">все четыре уголка</a> стоят на своих местах, значит просто переходим к следующему этапу, т.е. развороту уголков.</p>
    ...
    <p>2.1. Можно взять этими двумя уголками к себе и выполнить алгоритм <a href="rg2://ytplay?time=25:04&link=Oh7HESee4wY">\"Убийство в Лондоне\"</a>. <b>R’ U2 R U2 R’ F (R U R’ U’) R’ F’ R2</b></p>

    <p>2.2. Взять этими двумя уголками справа, наклонить головоломку крышей налево и <a href="rg2://ytplay?time=25:47&link=Oh7HESee4wY">выполнить \"Инфаркт\"</a>, причем заметьте, что в этом случае мы всегда поставим углы на свои места с первого раза, т.к. положение ребер нас пока не интересует. <b>(U2 R U2 R’) F2 (U2 L’ U2 L) F2</b></p>

    <p>2.3. А поскольку нас не интересует не только положение ребер, но пока и ориентация самих уголков, то можем взять двумя правильно стоящими уголками сзади и воспользоваться чуть более коротким <a href="rg2://ytplay?time=26:48&link=Oh7HESee4wY">алгоритмом из старой методики</a> для начинающих: <b>(R’ F’ L F)(R F’ L’ F)</b>, который не только меняет уголки местами, но еще и поворачивает их.</p>
    ...
    <p><a href="rg2://ytplay?time=36:52&link=Oh7HESee4wY">Алгоритм:</a> (R U R’ U’)(L’ U’ L U)(U R U’ R’)(U’ L’ U L)</p>

    <p style="text-align:center"><img src="penrose_8_2.xml" width="20%%"></p>

    <p><a href="rg2://ytplay?time=36:01&link=Oh7HESee4wY">Алгоритм:</a> (L’ U’ L U)(R U R’ U’)(U’ L’ U L)(U R U’ R’)</p>
    ...
    """
    static let st8_url = "Oh7HESee4wY"
