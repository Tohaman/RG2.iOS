...
struct Fisher: Phases {
    ...
    <p>Теперь, нам надо подружить центры среднего слоя с уже установленными ребрами. Сначала повернем верхнюю грань так, чтобы маленькие боковые наклейки белых ребер совпали по цветам с центрами среднего слоя. И теперь, если центры не совпадают с этими ребрами по цветам, нужно развернуть эти центры.</p>
